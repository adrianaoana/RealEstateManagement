...
public class Offer implements java.io.Serializable {
	...
	public Offer(String type, Feature feature, Address address, List<Image> images, String price, String emailUser,
			Date dateAdded, Date dateDeleted, String details, int id) {
		this.type = type;
	...
	public Offer(String type, String price, String emailUser, Date dateAdded, Feature feature, Address address,
			int id) {
		super();
		this.type = type;
		this.feature = feature;
